...
const indicator_t PROGMEM indicators[] = {
    // clang-format off
    KEYCODE_WITH_MOD_INDICATOR(OSM(MOD_LSFT), MOD_BIT_LSHIFT, RGB_CYAN),
    KEYCODE_WITH_MOD_INDICATOR(OSM(MOD_RSFT), MOD_BIT_RSHIFT, RGB_CYAN),
    KEYCODE_WITH_MOD_INDICATOR(KC_LSFT, MOD_BIT_LSHIFT, RGB_CYAN),
    KEYCODE_WITH_MOD_INDICATOR(KC_RSFT, MOD_BIT_RSHIFT, RGB_CYAN), // 4

    KEYCODE_WITH_MOD_INDICATOR(OSM(MOD_LCTL), MOD_BIT_LCTRL, RGB_RED),
    KEYCODE_WITH_MOD_INDICATOR(OSM(MOD_RCTL), MOD_BIT_RCTRL, RGB_RED),
    KEYCODE_WITH_MOD_INDICATOR(KC_LCTL, MOD_BIT_LCTRL, RGB_RED),
    KEYCODE_WITH_MOD_INDICATOR(KC_RCTL, MOD_BIT_RCTRL, RGB_RED),
    KEYCODE_WITH_MOD_INDICATOR(CTL_T(KC_Z), MOD_BIT_LCTRL, RGB_RED),
    KEYCODE_WITH_MOD_INDICATOR(RCTL_T(KC_SLSH), MOD_BIT_RCTRL, RGB_RED), // 10

    KEYCODE_WITH_MOD_INDICATOR(OSM(MOD_LALT), MOD_BIT_LALT, RGB_YELLOW),
    KEYCODE_WITH_MOD_INDICATOR(OSM(MOD_RALT), MOD_BIT_RALT, RGB_YELLOW),
    KEYCODE_WITH_MOD_INDICATOR(KC_LALT, MOD_BIT_LALT, RGB_YELLOW),
    KEYCODE_WITH_MOD_INDICATOR(KC_RALT, MOD_BIT_RALT, RGB_YELLOW), // 14

    KEYCODE_WITH_MOD_INDICATOR(OSM(MOD_LGUI), MOD_BIT_LGUI, RGB_GREEN),
    KEYCODE_WITH_MOD_INDICATOR(OSM(MOD_RGUI), MOD_BIT_RGUI, RGB_GREEN),
    KEYCODE_WITH_MOD_INDICATOR(KC_LGUI, MOD_BIT_LGUI, RGB_GREEN),
    KEYCODE_WITH_MOD_INDICATOR(KC_RGUI, MOD_BIT_RGUI, RGB_GREEN), // 18

    KEYCODE_INDICATOR(QK_BOOTLOADER, RGB_RED),
    KEYCODE_INDICATOR(QK_MAKE, RGB_GREEN),
    KEYCODE_INDICATOR(QK_REBOOT, RGB_YELLOW),
    KEYCODE_INDICATOR(QK_CLEAR_EEPROM, RGB_BLUE), // 22

    KEYCODE_IN_LAYER_INDICATOR(KC_1, _GAMEPAD, RGB_WHITE),
    KEYCODE_IN_LAYER_INDICATOR(KC_2, _GAMEPAD, RGB_GREEN),
    KEYCODE_IN_LAYER_INDICATOR(KC_3, _GAMEPAD, RGB_PURPLE),
    KEYCODE_IN_LAYER_INDICATOR(KC_Q, _GAMEPAD, RGB_GREEN),
    KEYCODE_IN_LAYER_INDICATOR(KC_W, _GAMEPAD, RGB_CYAN),
    KEYCODE_IN_LAYER_INDICATOR(KC_E, _GAMEPAD, RGB_RED),
    KEYCODE_IN_LAYER_INDICATOR(KC_R, _GAMEPAD, RGB_ORANGE),
    KEYCODE_IN_LAYER_INDICATOR(KC_A, _GAMEPAD, RGB_CYAN),
    KEYCODE_IN_LAYER_INDICATOR(KC_S, _GAMEPAD, RGB_CYAN),
    KEYCODE_IN_LAYER_INDICATOR(KC_D, _GAMEPAD, RGB_CYAN), // 32
    // clang-format on
};
#    endif
