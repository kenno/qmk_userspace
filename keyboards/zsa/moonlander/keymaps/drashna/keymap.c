...
const indicator_t PROGMEM indicators[] = {
    ...
    KEYCODE_WITH_MOD_INDICATOR(KC_RSFT, MOD_BIT_RSHIFT, RGB_CYAN),
    ...
    KEYCODE_WITH_MOD_INDICATOR(RCTL_T(KC_SLSH), MOD_BIT_RCTRL, RGB_RED),
    ...
    KEYCODE_WITH_MOD_INDICATOR(KC_RALT, MOD_BIT_RALT, RGB_YELLOW),
    ...
    KEYCODE_WITH_MOD_INDICATOR(KC_RGUI, MOD_BIT_RGUI, RGB_GREEN),
    ...
    KEYCODE_IN_LAYER_INDICATOR(KC_D, _GAMEPAD, RGB_CYAN),
    // clang-format on
};
#    endif
