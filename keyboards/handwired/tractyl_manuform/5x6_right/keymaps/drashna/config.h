...
#define DRV2605L_I2C_TIMEOUT  10
...
#    define WEAR_LEVELING_SIZE_KB            32
#    define WEAR_LEVELING_BACKING_MULTIPLIER 4
#    define WEAR_LEVELING_LOGICAL_SIZE       (WEAR_LEVELING_SIZE_KB * 1024)
#    define WEAR_LEVELING_BACKING_SIZE       (WEAR_LEVELING_SIZE_KB * 1024 * WEAR_LEVELING_BACKING_MULTIPLIER)
#else
