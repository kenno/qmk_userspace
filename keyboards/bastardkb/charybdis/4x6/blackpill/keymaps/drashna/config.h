...
#define DISPLAY_CS_PIN      B14
#define DISPLAY_RST_PIN     C14
#define DISPLAY_SPI_DIVIDER 2
...
#define BOOTMAGIC_EEPROM_ROW_RIGHT    1
#define BOOTMAGIC_EEPROM_COLUMN_RIGHT 0
